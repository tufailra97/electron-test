...
const filesToDownload = [
  {
    ...
    subtitle: 'By Blender Foundation 1',
    thumb:
      'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/BigBuckBunny.jpg',
    title: 'Big Buck Bunn1y 1',
  },
  {
    ...
    subtitle: 'By Blender Foundation 2',
    thumb:
  ...
  },
  {
    ...
    subtitle: 'By Google 5',
    thumb:
      'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/ForBiggerFun.jpg',
    title: 'For Bigger Fun 5',
  },
  {
    description:
  ...
  },
  {
    ...
    title: 'Subaru Outback On Street And Dirt 9',
  },
  {
    description:
  ...
  },
  {
    ...
    title: 'Volkswagen GTI Review 11',
  },
  {
    description:
    ...
    title: 'We Are Going On Bullrun 12',
  },
  {
    description:
    ...
    title: 'What care can you get for a gran 13',
  },
];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const downloadVideo = async () => {
      for (let i = 0; i < filesToDownload.length; i++) {
        const dest = `./src/public/videos/${filesToDownload[i].title}.mp4`;
        if (fs.existsSync(dest)) {
          return;
        }

        const req = await axios.get(filesToDownload[i].sources[0], {
  ...
  return (
    <div>
      ...
      {!isLoading && (
        <iframe src="C:\Users\Tufail\Desktop\electron\electron-react-boilerplate\src\public\index.html"></iframe>
      )}
    </div>
  );
}
